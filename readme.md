...
Простая замена **одного такого ребра на два ненаправленных** позволяет обойти ограничение:
...
Нам понадобится подключить к новому проекту файлы:
...
И примерно такой код в новый main.cpp :

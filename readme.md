...
Обратите внимание на разницу в понятиях **узел** и **сосед**, т.к. не все узлы являются соседями друг другу. Когда мы говорим про узел, подразумевается, что на текущей итерации мы выбрали его из графа и обходим подключенные интерфейсы в поисках смежных сущностей. После обновления кумулятивных костов, выбирается следующий узел, которым может стать в том числе и какой-нибудь сосед из предыдущего шага. Когда-то он был чьим-то соседом, а сейчас он выбранный узел. Выбранный - это переходящий титул. Выбранным любой из узлов может стать только один раз. А вот соседом, для которого пересматривается кум. кост, может становиться несколько раз за время работы алгоритма.
